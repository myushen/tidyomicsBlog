...
```{r fit, warning=FALSE, message=FALSE, cache=TRUE, results='hide'}
...
The plotting functionalities have been improved. Now, both discrete and continuous variables can be visualised overlaying the  data distribution from the model. This helps the user understanding whether the model is descriptively adequate to the data.
